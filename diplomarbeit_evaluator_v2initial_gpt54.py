#!/usr/bin/env python3
"""
Evaluator V2-initial: Evaluates results from results_v2_structural.jsonl
Uses 'initial_response' field (BEFORE structural feedback was applied).
Output: diplomarbeit_output/diplomarbeit_report_v2initial_gpt54.md
"""
...
REPORT_FILE = os.path.join(OUTPUT_DIR, "diplomarbeit_report_v2initial_gpt54.md")
EVAL_MODEL = "gpt-5.4"
...
def evaluate_model_teil(teil_key, teil_name, kategorie, model, outputs, config):
    ...
    for i, o in enumerate(outputs, 1):
        ...
        response_field = o.get("initial_response", o.get("response", ""))
